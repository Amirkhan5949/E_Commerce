...
public class Product {
    ...
    public Map<String, com.example.e_commerce_user.model.Size> getSize() {
        return Size;
    }

    public void setSize(Map<String, com.example.e_commerce_user.model.Size> size) {
        Size = size;
    }
    ...
    public Map<String, com.example.e_commerce_user.model.Color> getSelectedColor() {
        return SelectedColor;
    }

    public void setSelectedColor(Map<String, com.example.e_commerce_user.model.Color> selectedColor) {
